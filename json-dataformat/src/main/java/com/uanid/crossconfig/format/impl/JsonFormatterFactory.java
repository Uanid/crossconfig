...
public class JsonFormatterFactory implements FormatterFactory {
    private static final FormatterType FORMATTER_TYPE = new FormatterType("DefaultJacksonJSON", "JacksonJSON", "JSON");

    private JsonFormatterFactory() {
    }

    public static JsonFormatterFactory getInstance() {
    ...
    private static class SingletonHolder {
        private static final JsonFormatterFactory INSTANCE = new JsonFormatterFactory();
    }
}
